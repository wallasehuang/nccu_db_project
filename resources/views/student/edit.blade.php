...
<div class="container">
  <div class="card">
   <form class="form-horizontal" method="post" id="form" action="{{URL::to('student/edit')}}">
    <div class="modal-content row">
      <div class="modal-header col-lg-12">
      <h4 class="modal-title">學生管理 > 編輯</h4>
      </div>
      ...
      <div class="modal-body col-lg-12">
        <div class="form-group" >
          ...
          <div class="col-lg-8">
            <div class="fg-line">
              <input type="text" class="form-control input-sm" name="studentNo" placeholder="請輸入學號" value="{{ $student->studentNo }}">
            </div>
          </div>
        </div>
        <div class="form-group" >
          ...
          <div class="col-lg-8">
            <div class="fg-line">
              <input type="text" class="form-control input-sm"  name="name" placeholder="請輸入姓名" value="{{$student->name}}">
            </div>
          </div>
        </div>
        <div class="form-group" >
          ...
          <div class="col-lg-8">
            <div class="fg-line">
              <input type="text" class="form-control input-sm"  name="phone" placeholder="請輸入聯絡電話" value="{{$student->phone}}">
            </div>
          </div>
        </div>
      </div>
    ...
    var validator = $("#form").validate({
      rules: {
        studentNo:{
          required:true,
          digits:true,
          remote:"{{URL::to('student/check?id='.$student->id)}}"
        },
        name:"required",
        phone:{
          required:true,
